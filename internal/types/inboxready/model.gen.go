...
// dMARCReportsBasicAuthContextKey is the context key for DMARC_Reports_basicAuth security scheme
type dMARCReportsBasicAuthContextKey string

// domainBlocklistMonitoringBasicAuthContextKey is the context key for Domain_Blocklist_Monitoring_basicAuth security scheme
type domainBlocklistMonitoringBasicAuthContextKey string

// inboxPlacementTestingBasicAuthContextKey is the context key for Inbox_Placement_Testing_basicAuth security scheme
type inboxPlacementTestingBasicAuthContextKey string

// inboxReadyBasicAuthContextKey is the context key for Inbox_Ready_basicAuth security scheme
type inboxReadyBasicAuthContextKey string

// maverickScoreBasicAuthContextKey is the context key for Maverick_Score_basicAuth security scheme
type maverickScoreBasicAuthContextKey string

// spamtrapsAnalyticsServiceBasicAuthContextKey is the context key for Spamtraps_Analytics_Service_basicAuth security scheme
type spamtrapsAnalyticsServiceBasicAuthContextKey string

// basicAuthContextKey is the context key for basicAuth security scheme
type basicAuthContextKey string

// reputationanalyticsBasicAuthContextKey is the context key for reputationanalytics_basicAuth security scheme
type reputationanalyticsBasicAuthContextKey string
